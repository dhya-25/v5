...
@Component({
  selector: 'app-opposition-rh',
  templateUrl: './opposition-rh.component.html',
  styleUrls: ['./opposition-rh.component.scss']
})
export class OppositionRhComponent implements OnInit {
